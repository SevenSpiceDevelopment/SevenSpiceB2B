    ...
    <div className="flex-grow flex flex-col w-full animate-fadeIn">
      ...
      >
        ...
        <div className="max-w-container-max mx-auto px-margin-mobile md:px-margin-desktop relative z-10 w-full">
          <div className="max-w-3xl flex flex-col gap-3 text-left animate-fade-in-up">
      ...
      <div className="max-w-container-max mx-auto px-margin-mobile md:px-margin-desktop py-12 md:py-16 w-full flex-grow flex flex-col gap-stack-lg">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6 lg:gap-8 items-start">
          ...
          <div className="md:col-span-7 bg-surface-container-lowest border border-on-surface/10 rounded-2xl p-stack-md md:p-stack-lg relative overflow-hidden shadow-[0_18px_55px_rgba(87,0,19,0.08)] reveal-on-scroll delay-100">
          ...
          <div className="md:col-span-5 flex flex-col gap-6 reveal-on-scroll delay-200">
